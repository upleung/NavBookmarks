    ...
    <main class="admin-main">
      ...
      <div class="admin-content">
        <div v-if="page==='welcome'" class="welcome-page">
          <h2 class="welcome-title">欢迎您进入 NavBookmarks 后台管理系统</h2>
      ...
      <footer class="admin-footer">
        <p class="admin-copyright">Copyright © 2025 NavBookmarks | <a href="https://github.com/upleung/NavBookmarks" target="_blank" class="footer-link">Powered by upleung</a></p>
      </footer>
    </main>
  </div>
</template>
